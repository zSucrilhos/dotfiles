...
| Main Music Player | [ncmpcpp](https://github.com/arybczak/ncmpcpp) with [MPD](https://github.com/MusicPlayerDaemon/MPD) and [Clementine](https://www.clementine-player.org/pt_BR/)|
| Main Video Player | [mpv](https://github.com/mpv-player/mpv) and [VLC](https://www.videolan.org/vlc/index.pt-BR.html) |
| Main Image Viewer | [sxiv](https://github.com/muennich/sxiv) and [Viewnior](https://github.com/hellosiyan/Viewnior) |
...
| Main Terminal Emulator | [termite](https://github.com/thestinger/termite) and [alacritty](https://github.com/jwilm/alacritty) |
